/**
  ******************************************************************************
  * @file    stm32f4xx_nucleo_ExtnRF24L01.h
  * @author  '^_^'
  * @version V0.0.0
  * @date    28-September-2014
  * @brief   This file contains all the functions prototypes for the 
  *               stm32f4xx_nucleo_ExtnRF24L01.c firmware driver.
  ******************************************************************************  
  */ 

/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __STM32F4XX_NUCLEO_EXTNRF24L01_H
#define __STM32F4XX_NUCLEO_EXTNRF24L01_H
...
/* nRF24L01 Pipe Address struct */
typedef struct
{
	uint8_t *LOCAL_TX_ADDR;
	uint8_t *RX_ADDR0;
	uint8_t *RX_ADDR1;
	uint8_t *RX_ADDR2;
	uint8_t *RX_ADDR3;
	uint8_t *RX_ADDR4;
	uint8_t *RX_ADDR5;
}nRF24L01_PipeAddr_InitTypedef;

/* nRF24L01 struct */
typedef struct
{
	nRF24L01_PipeAddr_InitTypedef *Addr;
	uint8_t AUTO_ACK;
	uint8_t RX_PIPE;
	uint8_t COM_FREQ;
...
#define nRF24L01_SPIx_CLK_ENABLE()                 __SPI1_CLK_ENABLE()
#define nRF24L01_SPIx_FORCE_RESET()                __SPI1_FORCE_RESET()
#define nRF24L01_SPIx_RELEASE_RESET()              __SPI1_RELEASE_RESET()

#define nRF24L01_SPIx_SCK_AF                         GPIO_AF5_SPI1
#define nRF24L01_SPIx_SCK_GPIO_PORT                  GPIOB
#define nRF24L01_SPIx_SCK_PIN                        GPIO_PIN_3
#define nRF24L01_SPIx_SCK_GPIO_CLK_ENABLE()        __GPIOB_CLK_ENABLE()
#define nRF24L01_SPIx_SCK_GPIO_CLK_DISABLE()       __GPIOB_CLK_DISABLE()

#define nRF24L01_SPIx_MISO_MOSI_AF                   GPIO_AF5_SPI1
#define nRF24L01_SPIx_MISO_MOSI_GPIO_PORT            GPIOB
#define nRF24L01_SPIx_MISO_MOSI_GPIO_CLK_ENABLE()  __GPIOB_CLK_ENABLE()
#define nRF24L01_SPIx_MISO_MOSI_GPIO_CLK_DISABLE() __GPIOB_CLK_DISABLE()
#define nRF24L01_SPIx_MISO_PIN                       GPIO_PIN_4
#define nRF24L01_SPIx_MOSI_PIN                       GPIO_PIN_5

#define nRF24L01_SPIx_TIMEOUT_MAX                    1000
...
#define nRF24L01_CE_GPIO_CLK_DISABLE()             __GPIOB_CLK_DISABLE()

#define nRF24L01_CSN_PIN                             GPIO_PIN_2
#define nRF24L01_CSN_GPIO_PORT                       GPIOD
#define nRF24L01_CSN_GPIO_CLK_ENABLE()             __GPIOD_CLK_ENABLE()
#define nRF24L01_CSN_GPIO_CLK_DISABLE()            __GPIOD_CLK_DISABLE()

#define nRF24L01_CE_LOW()                            HAL_GPIO_WritePin(nRF24L01_CE_GPIO_PORT, \
                                                     nRF24L01_CE_PIN, GPIO_PIN_RESET)
#define nRF24L01_CE_HIGH()                           HAL_GPIO_WritePin(nRF24L01_CE_GPIO_PORT, \
                                                     nRF24L01_CE_PIN, GPIO_PIN_SET)

#define nRF24L01_CSN_LOW()                           HAL_GPIO_WritePin(nRF24L01_CSN_GPIO_PORT, \
                                                     nRF24L01_CSN_PIN, GPIO_PIN_RESET)
#define nRF24L01_CSN_HIGH()                          HAL_GPIO_WritePin(nRF24L01_CSN_GPIO_PORT, \
                                                     nRF24L01_CSN_PIN, GPIO_PIN_SET)

#define nRF24L01_IRQ_PIN                             GPIO_PIN_8
#define nRF24L01_IRQ_GPIO_PORT                       GPIOA
#define nRF24L01_IRQ_GPIO_CLK_ENABLE()             __GPIOA_CLK_ENABLE()
#define nRF24L01_IRQ_GPIO_CLK_DISABLE()            __GPIOA_CLK_DSIABLE()

//#define nRF24L01_IRQ_State()                         HAL_GPIO_ReadPin(nRF24L01_IRQ_GPIO_PORT, \
//                                                     nRF24L01_IRQ_PIN)
#define nRF24L01_IRQ_State()                          ((nRF24L01_IRQ_GPIO_PORT->IDR & nRF24L01_IRQ_PIN)? \
                                                      GPIO_PIN_SET : GPIO_PIN_RESET)

#define Addr_Width(x)                       ((x < 2)? ADR_WIDTH : 1)
...
#endif /* __STM32F4XX_NUCLEO_EXTNRF24L01_H */
