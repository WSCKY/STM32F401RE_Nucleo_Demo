...
#define VS1003_SPI								SPI2
#define VS1003_SPI_CLK_ENABLE()					__SPI2_CLK_ENABLE()
#define VS1003_SPI_SCK_GPIO_CLK_ENABLE()		__GPIOB_CLK_ENABLE()
#define VS1003_SPI_MISO_GPIO_CLK_ENABLE()		__GPIOB_CLK_ENABLE()
#define VS1003_SPI_MOSI_GPIO_CLK_ENABLE()		__GPIOB_CLK_ENABLE()

#define VS1003_SPI_FORCE_RESET()				__SPI2_FORCE_RESET()
#define VS1003_SPI_RELEASE_RESET()				__SPI2_RELEASE_RESET()

/* Definition for VS1003_SPI Pins */
#define VS1003_SPI_SCK_PIN						GPIO_PIN_13
#define VS1003_SPI_SCK_GPIO_PORT				GPIOB
#define VS1003_SPI_SCK_AF						GPIO_AF5_SPI2
#define VS1003_SPI_MISO_PIN						GPIO_PIN_14
#define VS1003_SPI_MISO_GPIO_PORT				GPIOB
#define VS1003_SPI_MISO_AF						GPIO_AF5_SPI2
#define VS1003_SPI_MOSI_PIN						GPIO_PIN_15
#define VS1003_SPI_MOSI_GPIO_PORT				GPIOB
#define VS1003_SPI_MOSI_AF						GPIO_AF5_SPI2

/* Definition for VS1003's other pins */
#define VS1003_XCS_PIN							GPIO_PIN_12
#define VS1003_XCS_GPIO_PORT					GPIOB
#define VS1003_XCS_GPIO_CLK_ENABLE()			__GPIOB_CLK_ENABLE()

#define VS1003_XDCS_PIN							GPIO_PIN_2
#define VS1003_XDCS_GPIO_PORT					GPIOA
#define VS1003_XDCS_GPIO_CLK_ENABLE()			__GPIOA_CLK_ENABLE()

#define VS1003_RESET_PIN						GPIO_PIN_3
#define VS1003_RESET_GPIO_PORT					GPIOA
#define VS1003_RESET_GPIO_CLK_ENABLE()			__GPIOA_CLK_ENABLE()

#define VS1003_DREQ_PIN							GPIO_PIN_15
#define VS1003_DREQ_GPIO_PORT					GPIOC
#define VS1003_DREQ_GPIO_CLK_ENABLE()			__GPIOC_CLK_ENABLE()
#define VS1003_DREQ_EXIT_IRQn					EXTI15_10_IRQn
