/******************************************************************************
  * @file    stm32f4xx_nucleo_ExtMPU6050.c
  * @author  '^_^'
  * @version V0.0.0
...
/* Includes ------------------------------------------------------------------*/
#include "stm32f4xx_nucleo_ExtMPU6050.h"

/* Private Defines -----------------------------------------------------------*/
//#define SCL_H()								MPU6050_I2C_SCL_GPIO_PORT->BSRRL |= MPU6050_I2C_SCL_PIN
//#define SCL_L()								MPU6050_I2C_SCL_GPIO_PORT->BSRRH |= MPU6050_I2C_SCL_PIN
//   
//#define SDA_H()								MPU6050_I2C_SDA_GPIO_PORT->BSRRL |= MPU6050_I2C_SDA_PIN
//#define SDA_L()								MPU6050_I2C_SDA_GPIO_PORT->BSRRH |= MPU6050_I2C_SDA_PIN

//#define SCL_Status()						MPU6050_I2C_SCL_GPIO_PORT->IDR & MPU6050_I2C_SCL_PIN
//#define SDA_Status()						MPU6050_I2C_SDA_GPIO_PORT->IDR & MPU6050_I2C_SDA_PIN
#define SDA_H()								HAL_GPIO_WritePin(MPU6050_I2C_SDA_GPIO_PORT, MPU6050_I2C_SDA_PIN, GPIO_PIN_SET)
#define SDA_L()								HAL_GPIO_WritePin(MPU6050_I2C_SDA_GPIO_PORT, MPU6050_I2C_SDA_PIN, GPIO_PIN_RESET)

#define SCL_H()								HAL_GPIO_WritePin(MPU6050_I2C_SCL_GPIO_PORT, MPU6050_I2C_SCL_PIN, GPIO_PIN_SET)
#define SCL_L()								HAL_GPIO_WritePin(MPU6050_I2C_SCL_GPIO_PORT, MPU6050_I2C_SCL_PIN, GPIO_PIN_RESET)

#define SCL_Status()						HAL_GPIO_ReadPin(MPU6050_I2C_SCL_GPIO_PORT, MPU6050_I2C_SCL_PIN)
#define SDA_Status()						HAL_GPIO_ReadPin(MPU6050_I2C_SDA_GPIO_PORT, MPU6050_I2C_SDA_PIN)
...
/**
  ...
  * @retval None.
  */
static void MPU6050_LowLevel_Init()
{
