/**
  ******************************************************************************
  * @file    stm32f4xx_nucleo_ExtMPU6050.h
  * @author  '^_^'
  * @version V0.0.0
  * @date    10-October-2014
  * @brief   Header file for stm32f4xx_nucleo_ExtMPU6050.c
  ******************************************************************************
  */

/* Define to prevent recursive inclusion -------------------------------------*/
#ifndef __STM32F4XX_NUCLEO_EXTMPU6050_H
#define __STM32F4XX_NUCLEO_EXTMPU6050_H
...
/**
  ...
  */
#define MPU6050_I2C_SDA_PIN					GPIO_PIN_8					/* PB.08 */
#define MPU6050_I2C_SDA_GPIO_PORT			GPIOB						/* GPIOB */
#define MPU6050_I2C_SDA_GPIO_CLK_ENABLE()	__GPIOB_CLK_ENABLE()
#define MPU6050_I2C_SDA_GPIO_CLK_DISABLE()	__GPIOB_CLK_DISABLE()

#define MPU6050_I2C_SCL_PIN					GPIO_PIN_9					/* PB.09 */
#define MPU6050_I2C_SCL_GPIO_PORT			GPIOB						/* GPIOB */
#define MPU6050_I2C_SCL_GPIO_CLK_ENABLE()	__GPIOB_CLK_ENABLE()
#define MPU6050_I2C_SCL_GPIO_CLK_DISABLE()	__GPIOB_CLK_DISABLE()
...
#endif /* __STM32F4XX_NUCLEO_EXTMPU6050_H */
